 ...
 * Stabilita la connessione è in grado di eseguire query e restituire in caso di
 * necessità una lista di mappe o una mappa che descrive un resultset La
 * conessione di questo dao è sempre aperta!
 * 
 */
public abstract class BasicDao {
	...
	/**
	 * Lista contenente mappe che descrivono delle entities nella persistenza. La
	 * mappa è praticamente la rappresentazione di una RIGA di una tabella. La lista
	 * quindi è l'insieme delle righe di una tabella
	 * 
	 ...
	 * 
	 * String sql = "SELECT * FROM tabella WHERE id = ?" => conditions[0] => 1 ?(1)
	 * => conditions[0] ?(2) => conditions[1]
	 * 
	 * @param sql        la query da inviare
	 * @param conditions il/i valore/i da sostituire ai placeholders della query
	...
	/**
	 * Restituisce un prepared statemen che � in grado di fornire l'id generato
	 * dall'inserimento
	 * 
	 * @param sql
	 * @param conditions
	...
	/**
	 * Metodo che effettua una insert e restituisce l'id che viene auto generato dal
	 * DB
	 * 
	 * @param sql
	 * @param conditions
